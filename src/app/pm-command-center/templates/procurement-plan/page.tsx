...
function ProcurementPlanContent() {
  ...
  const renderItems = () => (
    <div ref={itemsRef} style={{ marginBottom: "12px" }}>
      <table style={{ ...S.tbl, marginBottom: "0px" }}><tbody><tr><td style={S.sectionBanner(C.secondary)}> PROCUREMENT ITEMS</td></tr></tbody></table>
  ...
  const renderTimeline = () => (
    <div ref={timelineRef} style={{ marginBottom: "12px" }}>
      <table style={{ ...S.tbl, marginBottom: "0px" }}><tbody><tr><td style={S.sectionBanner(C.secondary)}> PROCUREMENT TIMELINE</td></tr></tbody></table>
