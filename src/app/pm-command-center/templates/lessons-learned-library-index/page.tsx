...
function LessonsLearnedLibraryIndexContent() {
  ...
  const renderSearch = () => (
    <div ref={searchRef} style={{ marginBottom: "12px" }}>
      <table style={{ ...S.tbl, marginBottom: "0px" }}><tbody><tr><td style={S.sectionBanner(C.secondary)}>🔍 SEARCH & FILTER GUIDE</td></tr></tbody></table>
  ...
  const renderTop = () => (
    <div ref={topRef} style={{ marginBottom: "12px" }}>
      <table style={{ ...S.tbl, marginBottom: "0px" }}><tbody><tr><td style={S.sectionBanner(C.secondary)}>🎯 TOP 5 MOST-REFERENCED LESSONS</td></tr></tbody></table>
