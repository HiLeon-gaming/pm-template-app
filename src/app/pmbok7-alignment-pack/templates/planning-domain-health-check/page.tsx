...
function PlanningDomainHealthCheckContent() {
  ...
  const renderDeps = () => (
    <div ref={depsRef} style={{ marginBottom: "12px" }}>
      <table style={{ ...S.tbl, marginBottom: "0px" }}><tbody><tr><td style={S.sectionBanner(accentDark)}>🔗 DEPENDENCY & ASSUMPTION STATUS</td></tr></tbody></table>
  ...
  const renderActions = () => (
    <div ref={actionsRef} style={{ marginBottom: "12px" }}>
      <table style={{ ...S.tbl, marginBottom: "0px" }}><tbody><tr><td style={S.sectionBanner(accent)}>⚡ PLANNING ACTIONS THIS WEEK</td></tr></tbody></table>
